		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="nav">
			<div
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/admin/studentList.do">학생계정</a>
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/admin/profList.do">교수계정</a>
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/admin/adminList.do">관리자계정</a>
						</div></li>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" 
							href="#">요청관리</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/admin/notice.do">공지사항	작성</a> 
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/admin/noticeList.do">공지사항	목록</a>
						</div></li>
			...
			<div class="navbar-collapse collapse order-3 dual-collapse2">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a class="nav-link">${mloginUser.mname }님 로그인중</a></li>
					<li class="nav-item">
						<a class="nav-link"
